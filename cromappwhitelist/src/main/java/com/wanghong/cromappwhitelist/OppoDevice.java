...
public class OppoDevice extends AbstractDevice {
    @Override
    ...
    protected ComponentName componentForNotificationSetting() {
        return new ComponentName("com.coloros.notificationmanager", "com.coloros.notificationmanager.NotificationCenterActivity");
    }
}
